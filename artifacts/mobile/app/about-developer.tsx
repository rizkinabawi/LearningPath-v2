...
const DEV = {
  ...
  bio: "Halo! Aku adalah developer di balik aplikasi ini. Aku suka membangun produk yang bermanfaat, belajar hal baru, dan berbagi ilmu dengan komunitas. 🚀",
  avatar: "👨‍💻",
  location: "Indonesia",
  skills: ["React Native", "Expo", "TypeScript", "UI/UX", "Node.js", "Figma"],
  socials: [
    {
